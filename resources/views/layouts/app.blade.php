...
<body style="background-color: #1E1226">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #002538">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="image/logo.png" alt="" style="width: 8vw">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}" style="color: white; font-family: 'gugi'" >{{ __('Login') }}</a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"  style="color: white ; font-family: 'gugi'">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
